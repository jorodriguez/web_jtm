            ...
            <template v-for="(itemCircuito, cindex) in circuitos">
              <v-row :key="cindex">
                <v-col md="12">
                  ...
                  >
                  <h5>Circuito {{cindex}} - }}</h5>
                    <draggable v-model="circuitos[cindex]" draggable=".item">
                      <template v-for="(row, i) in circuitoComputed(cindex)">                      
                        <v-hover
                          v-slot="{ hover }"
                          open-delay="200"
                          class="item"
...
export default {
  ...
  mounted() {
    ...
    this.usuarioSesion = getUsuarioSesion()
    this.cargarCatalogo()
    this.circuitos[1] = new Array();
    this.circuitos[2] = new Array();
    this.circuitos[3] = new Array();
    this.circuitos[4] = new Array();
  },
  computed: {
    circuitoComputed(index) {
      return this.circuitos[index];
    },
    numberOfPages() {
